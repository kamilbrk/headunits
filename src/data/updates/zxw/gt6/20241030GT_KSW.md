...
---
#### Summary
- Further changes for [`KSW_BENZ_LS`](/themes/zxw/48-ksw_benz_ls) theme
...
- Theme [`KSW_BENZ_LS`](/themes/zxw/48-ksw_benz_ls) with `id="48"` has even wider support across various apps
