...
---
Summary:
- New themes [`KSW_BMW_ID8_GS_DOUBLE`](/themes/zxw/53-ksw_bmw_id8_gs_double) and [`KSW_BENZ_GLC`](/themes/zxw/54-ksw_benz_glc)
...
- Further changes in the UI license activation checks that were introduced in [GT6 20240425GT_KSW](/updates/zxw/gt6/20240425gt_ksw), with another `/manualActivate` endpoint
