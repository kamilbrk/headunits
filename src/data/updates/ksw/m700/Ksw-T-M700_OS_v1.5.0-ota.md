...
- Free window on [`EVOID9_ALS`](/themes/ksw/evoid9_als) theme can be now hidden/shown
- Memory management optimisations on [`EVOID8_UG_2mode`](/themes/ksw/evoid8_ug_2mode) theme
