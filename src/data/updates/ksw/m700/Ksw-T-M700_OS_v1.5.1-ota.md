...
- Minor updates to `EVOID9_ALS` theme including new graphics, ability to show car speed in mph (in addition to existing kph) and support for more apps like Music, Video and Equalizer
