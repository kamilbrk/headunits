...
---
Summary:
- Updates that were also present in recent [M600](/updates/ksw) builds, since they're both coming from the same source. Expect roughly the same changes as between [M600 1.4.2](/updates/ksw/m600/ksw-t-m600_os_v142-ota) and [M600 1.6.1](/updates/ksw/m600/ksw-t-m600_os_v161-ota).
...
- KswPLauncher: Added more graphics, labels and functionality for [`UI_NTG6_FY_V3`](/themes/ksw/ui_ntg6_fy_v3) theme, including ability to change wallpaper, display temperature, etc.
